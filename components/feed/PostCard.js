...
const CommentInput = ({
  ...
  >
    ...
    {/* Icons */}
    <div
      className="flex-shrink-0 d-flex align-items-center ms-2"
      style={{ color: "var(--color-heading, #65676B)" }}
    >
      <button
        type="button"
        className="bg-transparent border-0 p-1 me-2 d-flex align-items-center justify-content-center"
      ...
      >
        ...
        >
          ...
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M19 10v2a7 7 0 01-14 0v-2M12 18v4m-4 0h8"
          />
        </svg>
      </button>
      <button
...
const CommentItem = ({
  ...
  const isLiked = comment.likes?.some(
    (like) => (typeof like === "object" ? like._id : like) === currentUser?._id,
  );
  ...
  const replies =
    allComments?.filter((c) => c.parentComment === comment._id) || [];

  return (
    <div
      className={`d-flex w-100 mb-3 ${level > 0 ? "mt-2" : ""}`}
      style={{ maxWidth: "100%" }}
    >
      ...
      <div className="flex-grow-1 position-relative" style={{ minWidth: 0 }}>
        ...
        >
          ...
          <span className="flex-shrink-0" style={{ fontWeight: 400 }}>
...
const PostCard = ({ post }) => {
  ...
  const [showEditVisibilityDropdown, setShowEditVisibilityDropdown] =
    useState(false);
  ...
  const handleEditSubmit = () => {
    ...
    updatePostMutation.mutate(
      { postId: post._id, postData: formData },
      {
        onSuccess: () => {
          setIsEditing(false);
          setEditFiles([]);
  ...
  return (
    <div className="_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16">
        ...
        <div className="_feed_inner_timeline_post_top">
          <div className="_feed_inner_timeline_post_box">
            <div className="_feed_inner_timeline_post_box_image">
              <UserAvatar user={post.author} size={50} className="_post_img" />
            </div>
          ...
          <div className="mt-2 mb-3 bg-white p-3 rounded border">
            <div className="d-flex align-items-center mb-2">
              <div className="position-relative">
                <button
                  ...
                  onClick={() =>
                    setShowEditVisibilityDropdown(!showEditVisibilityDropdown)
                  }
                >
                ...
                {showEditVisibilityDropdown && (
                  <div
                    className="position-absolute shadow-sm rounded p-1 mt-1 border bg-white"
                    style={{
                      zIndex: 10,
                      minWidth: "120px",
                      top: "100%",
                  ...
                  >
                    <button
                      ...
                      onClick={() => {
                        ...
                        setShowEditVisibilityDropdown(false);
                      }}
                    >
                      Public
                    </button>
            ...
            {post.images?.length > 0 && !removeDocImages && (
              <div className="position-relative mb-2">
                <button
                  ...
                  onClick={() => setRemoveDocImages(true)}
                />
            ...
            <div className="d-flex justify-content-between align-items-center mt-3 pt-2 border-top">
              ...
              <div className="d-flex gap-2">
                ...
                >
                  {updatePostMutation.isPending ? "..." : "Save"}
                </button>
              </div>
            </div>
          </div>
      ...
      <div className="_feed_inner_timeline_total_reacts _padd_r24 _padd_l24 _mar_b26">
        ...
        >
          {post.likes.length > 0 &&
            Array.from({ length: Math.min(post.likes.length, 5) }).map(
              (_, i) => (
                <UserAvatar
                  key={i}
                  user={post.likes[i]}
        ...
        <>
          <div className="_timline_comment_main mb-2">
            {!showAllComments && comments.length > 1 && (
              <div
                className="_previous_comment mb-3"
